<!DOCTYPE html>
    ...
    <link href="{{ asset('xlight/css/bootstrap.min.css') }}" rel="stylesheet">
	<link href="{{ asset('xlight/css/bootstrap-theme.min.css') }}" rel="stylesheet">
	<link href="{{ asset('xlight/css/animate.min.css') }}" rel="stylesheet" >	
	<link href="{{ asset('xlight/css/font-awesome.min.css') }}" rel="stylesheet">	
	<link href="{{ asset('xlight/css/prettyPhoto.css') }}" rel="stylesheet">
	
	<link href="{{ asset('xlight/css/theme.css') }}" rel="stylesheet">	
	<link href="{{ asset('xlight/css/responsive.css') }}" rel="stylesheet">
	<link href="{{ asset('xlight/css/colors/blue.css') }}" rel="stylesheet" class="colors">
...
<section id="home">
    <div id="home-slider" class="carousel slide carousel-fade" data-ride="carousel">
        <div class="carousel-inner">
			...
			<div class="item" style="background-image: url(/xlight/images/slider/bg-2.jpg)"> <!-- Change Image -->
				<div class="caption">
			...
			<div class="item" style="background-image: url(/xlight/images/slider/bg-3.jpg)"> <!-- Change Image -->
				<div class="caption">
			...
			<div class="container">	  
				<div class="row">
					...
					<div class="section-title wow fadeInUp" data-wow-duration="1s" data-wow-delay="300ms">			
						<h1><span>ABOUT Ethereal</span></h1>							
					</div>
							...
							<div class="team-member">
								<div class="team-member-holder wow flipInY" data-wow-duration="1s" data-wow-delay="300ms">
									<div class="team-member-image">
										<img src="/xlight/images/team/member-4.jpg" alt="" /> <!-- Change Image -->	
						...
						<div class="col-lg-3 col-md-3">
							<div class="team-member">
								<div class="team-member-holder wow flipInY" data-wow-duration="1s" data-wow-delay="500ms">
									<div class="team-member-image">
										<img src="/xlight/images/team/member-2.jpg" alt="" /> <!-- Change Image -->	
										<div class="team-overlay">
											<div class="img-overlay"></div>
										</div>
										<div class="overlay-content"> 
						...
						<div class="col-lg-3 col-md-3">
							<div class="team-member">
								<div class="team-member-holder wow flipInY" data-wow-duration="1s" data-wow-delay="800ms">
									<div class="team-member-image">
										<img src="/xlight/images/team/member-3.jpg" alt="" /> <!-- Change Image -->	
										<div class="team-overlay">
											<div class="img-overlay"></div>
										</div>
										<div class="overlay-content"> 
						...
						<div class="col-lg-3 col-md-3">
							<div class="team-member">
								<div class="team-member-holder wow flipInY" data-wow-duration="1s" data-wow-delay="1100ms">
									...
									<div class="team-member-meta">
										<h4 class="team-member-name"><span class="main-color">S</span>ai <span class="main-color">K</span>hant <span class="main-color">T</span>hura</h4>
										<div class="team-member-role">Junior Developer</div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="portfolio-wrap">
							<div class="myport wow fadeInDown" data-wow-duration="1s" data-wow-delay="600ms">
								<div class="mix category-1 portfolio" data-myorder="1">
									<div class="img-holder">
										<a class="folio-read-more" href="#" data-single_url="portfolio-single-image.html" title="This is the description">
											<img class="" src="/xlight/images/works/work1.jpg" alt="This is the title"> <!-- Change Image -->
								...
								<div class="mix category-2 portfolio" data-cat="category-2" data-myorder="2">
									<div class="img-holder">
										<a class="folio-read-more" href="#" data-single_url="portfolio-single-image.html" title="This is the description">									
										<img class="" src="/xlight/images/works/work2.jpg" alt="This is the title"> <!-- Change Image -->
											<div class="works-overlay">
												<div class="img-overlay"></div>
											</div>		
											<div class="overlay-content"> 
								...
								<div class="mix category-3 portfolio" data-cat="category-3" data-myorder="3">
									<div class="img-holder">
										<a class="folio-read-more" href="#" data-single_url="portfolio-single-image.html" title="This is the description">
											<img class="" src="/xlight/images/works/work3.jpg" alt="This is the title"> <!-- Change Image -->
											<div class="works-overlay">
												<div class="img-overlay"></div>
											</div>		
											<div class="overlay-content"> 
								...
								<div class="mix category-1 portfolio" data-cat="category-1" data-myorder="4">
									<div class="img-holder">
										<a class="folio-read-more" href="#" data-single_url="portfolio-slider.html" title="This is the description">
											<img class="" src="/xlight/images/works/work4.jpg" alt="This is the title"> <!-- Change Image -->
											<div class="works-overlay">
												<div class="img-overlay"></div>
											</div>		
											<div class="overlay-content"> 
								...
								<div class="mix category-2 portfolio" data-cat="category-2" data-myorder="5">
									<div class="img-holder">
										<a class="folio-read-more" href="#" data-single_url="portfolio-slider.html" title="This is the description">
											<img class="" src="/xlight/images/works/work5.jpg" alt="This is the title"> <!-- Change Image -->
											<div class="works-overlay">
												<div class="img-overlay"></div>
											</div>		
											<div class="overlay-content"> 
								...
								<div class="mix category-3 portfolio" data-cat="category-3" data-myorder="6">
									<div class="img-holder">
										<a class="folio-read-more" href="#" data-single_url="portfolio-slider.html" title="This is the description">
											<img class="" src="/xlight/images/works/work6.jpg" alt="This is the title"> <!-- Change Image -->
											<div class="works-overlay">
												<div class="img-overlay"></div>
											</div>		
											<div class="overlay-content"> 
								...
								<div class="mix category-1 portfolio" data-cat="category-1" data-myorder="7">
									<div class="img-holder">
										<a class="folio-read-more" href="#" data-single_url="portfolio-video-youtube.html" title="This is the description">
											<img class="" src="/xlight/images/works/work7.jpg" alt="This is the title"> <!-- Change Image -->
											<div class="works-overlay">
												<div class="img-overlay"></div>
											</div>		
											<div class="overlay-content"> 
								...
								<div class="mix category-2 portfolio" data-cat="category-2" data-myorder="8">
									<div class="img-holder">
										<a class="folio-read-more" href="#" data-single_url="portfolio-video-youtube.html" title="This is the description">
											<img class="" src="/xlight/images/works/work8.jpg" alt="This is the title"> <!-- Change Image -->
											<div class="works-overlay">
												<div class="img-overlay"></div>
											</div>		
											<div class="overlay-content"> 
								...
								<div class="mix category-3 portfolio" data-cat="category-3" data-myorder="9">
									<div class="img-holder">
										<a class="folio-read-more" href="#" data-single_url="portfolio-video-youtube.html" title="This is the description">
											<img class="" src="/xlight/images/works/work9.jpg" alt="This is the title"> <!-- Change Image -->
											<div class="works-overlay">
												<div class="img-overlay"></div>
											</div>		
											<div class="overlay-content"> 
								...
								<div class="mix category-1 portfolio" data-cat="category-1" data-myorder="10">
									<div class="img-holder">
										<a class="folio-read-more" href="#" data-single_url="portfolio-video-vimeo.html" title="This is the description">
											<img class="" src="/xlight/images/works/work10.jpg" alt="This is the title"> <!-- Change Image -->
											<div class="works-overlay">
												<div class="img-overlay"></div>
											</div>		
											<div class="overlay-content"> 
								...
								<div class="mix category-2 portfolio" data-cat="category-2" data-myorder="11">
									<div class="img-holder">
										<a class="folio-read-more" href="#" data-single_url="portfolio-video-vimeo.html" title="This is the description">
											<img class="" src="/xlight/images/works/work11.jpg" alt="This is the title"> <!-- Change Image -->
											<div class="works-overlay">
												<div class="img-overlay"></div>
											</div>		
											<div class="overlay-content"> 
								...
								<div class="mix category-3 portfolio" data-cat="category-3" data-myorder="12">
									<div class="img-holder">
										<a class="folio-read-more" href="#" data-single_url="portfolio-video-vimeo.html" title="This is the description">
											<img class="" src="/xlight/images/works/work12.jpg" alt="This is the title"> <!-- Change Image -->
											<div class="works-overlay">
												<div class="img-overlay"></div>
											</div>		
											<div class="overlay-content"> 
								...
								<div class="carousel-inner">
										...
										<div class="row">
											<div class="col-lg-12 col-sm-12">
												<div class="testimonial-inner">
													<img class="img-circle" src="/xlight/images/clients/person_1.jpg" alt="" title="" /><!-- Testimonial Image  -->
									...
									<div class="item">
										<div class="row">
											<div class="col-lg-12 col-sm-12">
												<div class="testimonial-inner">
													<img class="img-circle" src="/xlight/images/clients/person_2.jpg" alt="" title="" />
									...
									<div class="item">
										<div class="row">
											<div class="col-lg-12 col-sm-12">
												<div class="testimonial-inner">
													<img class="img-circle" src="/xlight/images/clients/person_3.jpg" alt="" title="" />
													<p>Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit!</p>
												</div>
				...
				<div class="row">
						...
						<div class="news-content wow fadeInLeft" data-wow-duration="1s" data-wow-delay="300ms">	
							<div class="entry-header">	
								<div class="blog-image">
									<a href="blog.html"><img alt="" src="/xlight/images/blog/post1.jpg" class="img-responsive"></a>
								</div>							
								<div class="post-date">
					...
					<div class="col-lg-6 col-sm-6">	
						<div class="news-content wow fadeInRight" data-wow-duration="1s" data-wow-delay="300ms">	
							<div class="entry-header">	
								<div class="blog-image">
									<a href="blog.html"><img alt="" src="/xlight/images/blog/post2.jpg" class="img-responsive"></a>
								</div>							
								<div class="post-date">
				...
				<div class="row">
					<div class="col-lg-6 col-sm-6">	
						<div class="news-content wow fadeInLeft" data-wow-duration="1s" data-wow-delay="600ms">	
							<div class="entry-header">	
								<div class="blog-image">
									<a href="blog.html"><img alt="" src="/xlight/images/blog/post3.jpg" class="img-responsive"></a>
								</div>							
								<div class="post-date">
					...
					<div class="col-lg-6 col-sm-6">	
						<div class="news-content wow fadeInRight" data-wow-duration="1s" data-wow-delay="600ms">	
							<div class="entry-header">	
								<div class="blog-image">
									<a href="blog.html"><img alt="" src="/xlight/images/blog/post4.jpg" class="img-responsive"></a>
								</div>							
								<div class="post-date">
...
<div class="bottom-footer">
	<div class="container"> 
		...
		<div class="bottom-footer-left wow fadeInUp" data-wow-duration="1s" data-wow-delay="450ms">
			<p><span>&#169; Copyright 2019 by</span>  <a href="#">Ethereal</a></p>
		</div>		  
	</div>
</div>
<!-- End Footer -->		
...
<!-- End Scroll To Top  -->
	...
	<script src="{{ asset('xlight/js/jquery.min.js') }}"></script>
	<script src="{{ asset('xlight/js/bootstrap.min.js') }}"></script>
	<!-- <script src="{{ asset('xlight/js/retina.min.js') }}"></script> -->
	<script src="{{ asset('xlight/js/jquery.easing.min.js') }}"></script>
	<script src="{{ asset('xlight/js/wow.min.js') }}"></script>	
	<script src="{{ asset('xlight/js/waypoints.min.js') }}"></script>	
	<script src="{{ asset('xlight/js/jquery.countTo.js') }}"></script>
	<script src="{{ asset('xlight/js/jquery.mixitup.min.js') }}"></script>
	<script src="{{ asset('xlight/js/jquery.prettyPhoto.js') }}"></script>	
	<script src="{{ asset('xlight/js/jquery.knob.min.js') }}"></script>	
	<script src="{{ asset('xlight/js/jquery.validate.min.js') }}"></script>
	<script src="{{ asset('xlight/js/custom.js') }}"></script>
